...
export const autoCompleteBaseListBox = getTestId('AutocompleteBase__listBox');
...
const quizPreviewRoot = getTestId('QuizReview__root');
...
export const quizExplanation = getTestId('QuizMain__explanation');

export const quizV2QuestionEditorInput = `${quizAnswerDescription} ${draftEditor}`;

export const quizAnswerEditorValidation = getTestId('QuizEditorHF__formHelperText');

export const quizQuestionHelperText = `${quizAnswerDescription} ${quizAnswerEditorValidation}`;

export const quizExplanationHelperText = `${quizExplanation} ${quizAnswerEditorValidation}`;
...
export const quizPreviewEditBtn = getTestId('QuizReview__editButton');
...
export const quizAnswerMultipleAnswerEditorInput = `${quizAnswerMultipleAnswerBoxes} ${draftEditor}`;

export const quizAnswerEditorInput = `${quizAnswerListItem} ${draftEditor}`;

export const quizAnswerEditorInputValidation = `${quizAnswerListItem} ${quizAnswerEditorValidation}`;

export const quizAnswerDescriptionEditorInputValidation = `${quizAnswerDescription} ${quizAnswerEditorValidation}`;
...
export const quizAnswerMultipleAnswerCorrectNth = (index: number) =>
    `${quizAnswerMultipleAnswerBoxes}:nth-child(${index}) input[type="checkbox"]`;
...
export const quizAnswerFillInBlankInputV2 = getTestId('QuizFIBAnswerInput__answer');
...
export const quizAnswerLabelTypeSelect = getTestId('QuizFIBTypeSelectHF__root');
...
export const editorLoadingImage = `[data-testid="Editor__loading-image"]`;
...
export const buttonRemoveTableActionStudent =
    '[data-testid="TableActionStudentInfo__buttonRemove"]';
// Quiz Question
