...
import {
    ...
    checkCameraStatusOnTeacherApp,
    checkSpeakerStatusOnLearnerApp,
    checkSpeakerStatusOnTeacherApp,
...
Given(
    ...
    { timeout: 1000000 },
    async function (this: IMasterWorld, deviceStatus: StatusCameraAndSpeaker) {
