...
Feature: Teacher cannot see pinned user when teacher or pinned user leaves lesson then rejoining
    ...
    Scenario: Teacher cannot see pinned student when teacher leaves lesson then rejoining
    ...
    Scenario: Teacher cannot see pinned teacher when teacher leaves lesson then rejoining
        Given "teacher T1" has "Pin for me" "teacher T1" on Teacher App
        When "teacher T1" leaves lesson on Teacher App
        And "teacher T1" rejoins lesson on Teacher App
        Then "teacher T1" does not see "teacher T1" stream with "camera" in the main screen on Teacher App
