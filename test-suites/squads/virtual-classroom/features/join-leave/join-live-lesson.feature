...
Feature: Can join a live lesson
  ...
  Scenario: Teacher can join a lesson after other teacher has joined
    ...
    Then "teacher T2" sees all teacher in gallery view on Teacher App
    And "teacher T2" sees student in gallery view on Teacher App
    And "teacher T1" sees all teacher in gallery view on Teacher App
    And "teacher T1" sees student in gallery view on Teacher App
