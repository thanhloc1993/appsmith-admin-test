...
Feature: Teacher can not spotlight for student for user when sharing material or starting polling
    Background:
    ...
    Scenario Outline: Teacher can not spotlight user for student when polling is started
