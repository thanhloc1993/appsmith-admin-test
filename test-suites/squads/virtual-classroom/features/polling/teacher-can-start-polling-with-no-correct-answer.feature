...
Feature: Teacher can start polling with no correct answer
    Background:
    ...
    Scenario: Teacher can start a polling with blank question and answer option along with no correct answer
        ...
        And all students see blank question and blank option list on Learner App

    Scenario: Teacher can start a polling with text question and answer option along with no correct answer
