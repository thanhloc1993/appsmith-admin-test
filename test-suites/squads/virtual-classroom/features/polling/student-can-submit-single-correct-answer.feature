...
Feature: Student can submit single correct answer
    Background:
    ...
    Scenario Outline: Student can submit single correct answer
        ...
        When "student" submits "<correct option>" options on Learner App
        ...
        And "teacher" sees "<incorrect option>" option has "0" answer ratio on Teacher App
        Examples:
