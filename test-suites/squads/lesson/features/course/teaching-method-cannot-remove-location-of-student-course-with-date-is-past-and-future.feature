...
Feature: School admin cannot remove location of a student course with start&end date is past&future
    Background:
        Given "school admin" logins CMS
        And "school admin" has gone to course page

    Scenario Outline: School admin cannot remove location of a student course with start&end date is past&future by X button
        ...
        And "school admin" has set start date is in the past and end date is in the future
    ...
    Scenario Outline: School admin cannot remove location of a student course with start&end date is past&future by deselecting location
        Given "school admin" has created a new course with "<type>" location
        And "school admin" has created a new student with "<type>" location
        And "school admin" has added course to student with "1" location which is from selected "<type>" location
        And "school admin" has set start date is in the past and end date is in the future
