...
Feature: School admin can or cannot remove location of an inactive student course
    Background:
        Given "school admin" logins CMS
        And "school admin" has gone to course page

    Scenario Outline: School admin cannot remove location of an inactive student course by X button
        ...
        And "school admin" has set start date and end date is in the past
