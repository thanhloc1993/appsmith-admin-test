...
Feature: School admin can apply location settings for past lesson list
    Background:
    ...
    Scenario Outline: School admin can apply location settings for past lesson list
        ...
        Then "school admin" is redirected to the first page of "past" lesson list page
    ...
    Scenario Outline: School admin sees full past lesson list when not applying any location in location settings
        ...
        Then "school admin" sees full "past" lesson list
