...
Feature: School Admin can/cannot cancel lesson by bulk in future lessons tab
    Background:
        Given "school admin" logins CMS

    Scenario Outline: School Admin can cancel lesson by bulk in future lessons tab
        Given "school admin" has created a "<status>" "<recurring_settings>" "<teaching_method>" lesson in the "future"
    ...
    Scenario Outline: School Admin cannot cancel lesson by bulk in future lessons tab
        Given "school admin" has created a "<status>" "<recurring_settings>" "<lesson_type>" lesson in the "future"
        And "school admin" has applied location in location settings is the same as location in the lesson
        And "school admin" has gone to "future" lessons list page
    ...
    Scenario Outline: School Admin cannot cancel locked lesson by bulk in future lessons tab
        Given "school admin" has created a "<status>" "<recurring_settings>" "<lesson_type>" lesson in the "future"
        And "school admin" has applied location in location settings is the same as location in the lesson
        And "school admin" has gone to "future" lessons list page
