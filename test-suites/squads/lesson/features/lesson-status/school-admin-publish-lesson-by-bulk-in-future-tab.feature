...
Feature: School Admin can/cannot publish lesson by bulk in future lessons tab
    Background:
        Given "school admin" logins CMS

    Scenario Outline: School Admin can publish lessons as Draft by bulk in future lessons tab
        Given "school admin" has created a "Draft" "<recurring_type>" "<method>" lesson in the "future" with all required fields
        ...
        Then "school admin" is still in the "future" lesson management page
    ...
    Scenario Outline: School Admin cannot publish lesson that has a different status Draft by bulk in future lesson tab
        Given "school admin" has created a "<status>" "<recurring_type>" "<method>" lesson in the "future"
        And "school admin" has applied location in location settings is the same as location in the lesson
        And "school admin" has gone to "future" lessons list page
    ...
    Scenario Outline: School Admin cannot publish lesson by bulk if missing required in future lessons tab
        Given "school admin" has created a "Draft" "<recurring_type>" "<method>" lesson in the "future" with missing required fields
        And "school admin" has applied location in location settings is the same as location in the lesson
        And "school admin" has gone to "future" lessons list page
        And "school admin" has selected the "Draft" "<recurring_type>" "<method>" lesson by checkbox
        When "school admin" clicks three dots icon
