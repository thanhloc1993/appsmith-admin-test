...
Feature: Teacher can edit submitted individual lesson report of future lesson
    Background:
    ...
    Scenario: Teacher can edit submitted lesson report of future lesson
    ...
    Scenario: Teacher cannot edit submitted lesson report of future lesson
