...
Feature: Teacher can discard editing a submitted individual lesson report of future lesson
    Background:
    ...
    Scenario Outline: Teacher can discard editing a submitted lesson report of future lesson
        ...
        And "teacher" still sees "Submitted" tag of lesson report
        Examples:
            | option              |
            | X button            |
            | Discard button      |
    ...
    Scenario Outline: Teacher can cancel discarding editing a submitted lesson report of future lesson
