...
Feature: Teacher can discard editing a submitted individual lesson report of past lesson
    Background:
    ...
    Scenario Outline: Teacher can discard editing a submitted lesson report of past lesson
    ...
    Scenario Outline: Teacher can cancel discarding editing a submitted lesson report of past lesson
