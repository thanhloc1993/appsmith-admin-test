...
Feature: Teacher can edit submitted individual lesson report of a past lesson in the recurring chain
    Background:
        Given "school admin" logins CMS
        And "teacher" logins CMS
        And "student" with course and enrolled status has logged Learner App
        And "school admin" has created a weekly recurring "individual" lesson with lesson date in the "past"
    ...
    Scenario: Teacher can edit submitted lesson report of past recurring lesson
    ...
    Scenario Outline: Teacher cannot edit submitted lesson report of past recurring lesson
        Given "teacher" has opened editing "individual" lesson report page
