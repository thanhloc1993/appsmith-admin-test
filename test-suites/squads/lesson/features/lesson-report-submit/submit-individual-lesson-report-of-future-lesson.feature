...
Feature: School admin can submit individual lesson report of future lesson
    Background:
    ...
    Scenario: School admin can submit lesson report of future lesson
    ...
    Scenario: School admin cannot submit lesson report of future lesson with missing field
    ...
    Scenario: School admin can cancel submitting lesson report of future lesson
        Given "school admin" has fulfilled lesson report info
