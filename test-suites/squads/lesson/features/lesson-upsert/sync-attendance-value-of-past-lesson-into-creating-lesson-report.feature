...
Feature: Sync Attendance value of past lesson into creating lesson report
    Background:
    ...
    Scenario Outline: Sync Attendance value of past lesson into creating lesson report
