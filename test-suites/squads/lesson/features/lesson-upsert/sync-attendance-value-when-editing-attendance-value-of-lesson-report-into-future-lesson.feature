...
Feature: Sync Attendance value when editing attendance value of lesson report into future lesson
    Background:
    ...
    Scenario Outline: Sync Attendance value when editing attendance value of lesson report into future lesson
