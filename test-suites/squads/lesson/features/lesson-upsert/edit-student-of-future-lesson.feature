...
Feature: School admin can edit student of future lesson which has lesson report
    Background:
    ...
    Scenario: School admin can cancel adding student in future lesson
        Given "school admin" has opened editing lesson page
        ...
        And "student S2" does not see the "future" lesson on Learner App
    ...
    Scenario: School admin can cancel removing student in future lesson
        Given "school admin" has opened editing lesson page
        ...
        And "student S1" still sees the "future" lesson on Learner App
