...
Feature: Teacher can edit future lesson which has no lesson report by updating and adding
    Background:
    ...
    Scenario: Teacher can update date&time in future lesson to past lesson
    ...
    Scenario: Teacher can update date&time in future lesson
    ...
    Scenario Outline: Teacher can update <field> in future lesson
    ...
    Scenario: Teacher can add teacher in future lesson
    ...
    Scenario: Teacher can add student in future lesson
    ...
    Scenario Outline: Teacher can not edit future lesson
