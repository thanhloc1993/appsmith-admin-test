...
Feature: School admin can edit future lesson which has no lesson report by updating and adding
    Background:
    ...
    Scenario: School admin can update date&time in future lesson to past lesson
    ...
    Scenario: School admin can update date&time in future lesson
    ...
    Scenario Outline: School admin can update <field> in future lesson
    ...
    Scenario: School admin can add teacher in future lesson
        ...
        And "teacher T2" sees the "future" lesson on Teacher App

    Scenario: School admin can add student in future lesson
        ...
        And "teacher T1" sees added "student S2" in student list of "future" lesson on Teacher App
        And "student S2" sees the new lesson on Learner App

    Scenario Outline: School admin can not edit future lesson
