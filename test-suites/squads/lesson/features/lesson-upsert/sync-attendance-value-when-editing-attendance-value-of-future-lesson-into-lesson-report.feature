...
Feature: Sync Attendance value when editing attendance value of future lesson into lesson report
    Background:
    ...
    Scenario Outline: Sync Attendance value when editing attendance value of future lesson into lesson report
