...
Feature: Cannot remove location of a future student course
    Background:
        Given "school admin" logins CMS
        And "school admin" has gone to course page

    Scenario Outline: School admin cannot remove location of a future student course by X button
        ...
        And "school admin" has added course for student with "<type>" location and start date and end date is in the future
