...
Feature: School Admin edits general information of weekly recurring group lesson
    ...
    Scenario Outline: School Admin edits Attendance Info and Material of a <status> recurring lesson with "This and the following lessons"
        Given "school admin" has created a "<status>" "Weekly Recurring" "group" lessons in the "future" with attached "<material>"
        ...
        When "school admin" updates "<attendance_status>", "<notice>", "<reason>", and "<note>" of student
        ...
        And "school admin" sees Attendance is "<attendance_status>", "<notice>", "<reason>", and "<note>" of student are updated
        ...
        Examples:
            | status    | material | attendance_status | notice     | reason             | note             |
            | Draft     | pdf      | Attend            |            |                    |                  |
