...
Feature: Teacher can edit draft group lesson report of a future lesson in the recurring chain
    Background:
        Given "school admin" logins CMS
        And "teacher" logins CMS
        And "school admin" has created a "Weekly Recurring" group lesson with filled all information in the "future"
    ...
    Scenario: Teacher can edit draft lesson report of future lesson recurring
