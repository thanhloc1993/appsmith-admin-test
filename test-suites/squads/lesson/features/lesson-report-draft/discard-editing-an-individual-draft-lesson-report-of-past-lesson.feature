...
Feature: Teacher can discard editing an individual draft lesson report of past lesson
    Background:
    ...
    Scenario Outline: Teacher can discard editing a draft lesson report of past lesson
    ...
    Scenario Outline: Teacher can cancel discarding editing a draft lesson report of past lesson
