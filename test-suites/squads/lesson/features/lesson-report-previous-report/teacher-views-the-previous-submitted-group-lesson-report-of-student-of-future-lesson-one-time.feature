...
Feature: Teacher can view the previous submitted group lesson report of future one time lesson
    Background:
    ...
    Scenario: Teacher can view the previous draft group lesson report in creating lesson report page
        Given "teacher" has created a "future" "One Time" group lesson after that lesson
        And "teacher" has gone to detailed the newly "future" lesson info page
        And "teacher" has opened creating "group" lesson report page
