...
Feature: Teacher can view the previous submitted individual lesson report of past recurring lesson
    Background:
        Given "school admin" logins CMS
        And "teacher" logins CMS
        And "student" with course and enrolled status has logged Learner App
        And "teacher" has created a weekly recurring individual lesson in the "past"
    ...
    Scenario: Teacher can view the previous draft individual lesson report in creating lesson report page
        Given "teacher" has created a "past" "One Time" individual lesson after that lesson
        And "teacher" has gone to detailed the newly "past" lesson info page
        And "teacher" has opened creating "individual" lesson report page
    ...
    Scenario: Teacher can view the previous submitted past individual recurring lesson report in detailed lesson report page
        Given "teacher" has created a "past" "Weekly Recurring" individual lesson after that lesson
        And "teacher" has gone to detailed the newly "past" lesson info page
        And "teacher" has opened creating "individual" lesson report page
        And "teacher" has fulfilled individual lesson report info
