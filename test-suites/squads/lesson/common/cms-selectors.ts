...
export const lessonLinkOfFirstRowOnLessonListWithTab = (tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} ${lessonRowFirstInList} ${lessonLink}`;
export const lessonLinkOfSecondRowOnLessonListWithTab = (tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} ${lessonRowNumberInList(2)} ${lessonLink}`;

export const lessonRowOfSecondRowOnLessonListWithTab = (tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} ${lessonRowNumberInList(2)}`;
export const lessonListFuture = '[data-testid="LessonList__future"]';
export const lessonListPast = '[data-testid="LessonList__past"]';

export const addLessonOnListFuture =
    '[data-testid="LessonList__future"] [data-testid="TabLessonList__buttonAdd"]';
...
export const lessonTableRowWithTab = (tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} tr[data-testid="TableBase__row"]`;
...
export const lessonLinkInPastLesson = `${lessonListPast} ${lessonLink}`;

export const lessonLinkByOrderWithTab = (order: number, tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} a[data-testid="TableLessonsWithPaging__lessonDate"] >> nth=${order}`;
...
export const lessonLinkOfRowOnLessonListByOrderWithTab = (nth: number, tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} ${lessonRowNumberInList(nth)} ${lessonLink}`;

export const lessonRowOnLessonListByOrderWithTab = (nth: number, tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} ${lessonRowNumberInList(nth)}`;
...
export const lessonOnListWithDataValueTab = (value: string, tab: LessonTimeValueType) =>
    `${lessonListTab(tab)} [data-testid="TableLessonsWithPaging__root"] tr[data-value="${value}"]`;
...
export const radioButtonLessonRecurring =
    'span[data-testid="Radio__CREATE_LESSON_SAVING_METHOD_ONE_TIME"] input';
...
export const teacherChip = `${teacherAutocompleteV3} [data-testid="ChipAutocomplete"]`;
...
export const removeAutocompleteClass =
    '[data-testid="FormLessonUpsertV3__class"] button[aria-label="Clear"]';
...
export const checkBoxStudentInfoTable =
    '[data-testid="TableCellStudentSubscriptionV2__studentName"]';

export const studentNameOnLessonUpsertTable = (studentName: string) =>
    `[data-testid="TableCellStudentSubscriptionV2__studentName"]:has-text("${studentName}")`;
...
export const uploadMaterialButton = 'div[data-testid="UploadInput"]';
...
export const contentTextAreaGroupLessonReport =
    '[data-testid="DynamicFieldBase__TEXT_FIELD_AREA__content"] textarea#DynamicFieldBase__TEXT_FIELD_AREA__content';
export const homeworkTextAreaGroupLessonReport =
    '[data-testid="DynamicFieldBase__TEXT_FIELD_AREA__homework"] textarea#DynamicFieldBase__TEXT_FIELD_AREA__homework';
export const announcementTextAreaGroupLessonReport =
    '[data-testid="DynamicFieldBase__TEXT_FIELD_AREA__announcement"] textarea#DynamicFieldBase__TEXT_FIELD_AREA__announcement';
export const remarkInternalOnlyTextAreaGroupLessonReport =
    '[data-testid="DynamicFieldBase__TEXT_FIELD_AREA__lesson_remark"] textarea#DynamicFieldBase__TEXT_FIELD_AREA__lesson_remark';
export const numberSeedingInLessonQuizInput =
    '[data-testid="DynamicFieldBase__TEXT_FIELD_PERCENTAGE__in_lesson_quiz"] input';
export const autocompleteHomeworkCompletion =
    '[data-testid="DynamicFieldBase__SELECT_ICON__homework_completion"]';
export const remarkTextAreaGroupLessonReport =
    '[data-testid="DynamicFieldBase__TEXT_FIELD__student_remark"] input';
export const dialogFullScreenContent = '[data-testid="DialogFullScreen__content"]';

// Filter Lesson Page
export const autoCompleteFilterStudent = `[data-testid="FilterLessonList__students"]`;
export const autoCompleteFilterTeacher = `[data-testid="FilterLessonList__teachers"]`;

export const formFilterLessonEndDate = `[data-testid="FilterLessonList__toDate"]`;
export const tableBaseNoData = '[data-testid="TableBase__noDataMessage"]';
export const studentInfoNoData = `[data-testid="DetailSectionLessonStudents__root"] ${tableBaseNoData}`;

export const locationLessListWithNth = (tab: LessonTimeValueType, nth: number) =>
    `${lessonListTab(tab)} [data-testid="TableLessonsWithPaging__location"] >> nth =${nth}`;

export const noInformationStudentInfo =
    '[data-testid="TableStudentsInfoWithActionsV2__wrapper"] svg[data-testid="NoData__icon"]';

export const bulkActionAttendanceStatusLessonUpsert =
    'button[data-testid="TableDynamicFieldHeader__bulkActionIcon"]';

export const bulkActionDynamicField = '[data-testid="TableDynamicFieldBulkAction__dynamicField"]';

export const selectTeachingMediumInput = '[data-testid="SelectHF__select"]';

export const getSelectTeachingMediumOption = (value: TeachingMedium) => `[data-value="${value}"]`;

export const addStudentDropdownButton =
    '[data-testid="TableActionStudentInfo__container"] [data-testid="ButtonDropdownMenu__button"]';

export const addNormalStudentOption = '[role="menuitem"][data-value="ADD_STUDENT"]';
export const addReallocateStudentOption = '[role="menuitem"][data-value="REALLOCATE_STUDENT"]';

export const addStudentDialogTitle =
    '[data-testid="DialogWithHeaderFooter__dialogTitle"]:has-text("Add Student")';

export const addReallocateStudentDialogTitle =
    '[data-testid="DialogWithHeaderFooter__dialogTitle"]:has-text("Reallocate Student")';
