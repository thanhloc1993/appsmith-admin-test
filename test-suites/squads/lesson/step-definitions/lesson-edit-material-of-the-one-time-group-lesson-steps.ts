...
Given(
    '{string} has created a {string} {string} lesson in the {string} with attached {string}',
    { timeout: 300000 },
    async function (
        role: AccountRoles,
        ...
        await cms.instruction(
            `${role} has created a ${recurringSetting} ${lessonType} lesson in the ${lessonTime} with attached ${rawMaterial}`,
            async function () {
