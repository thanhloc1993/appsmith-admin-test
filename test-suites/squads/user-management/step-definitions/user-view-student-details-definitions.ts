...
export async function viewStudentDetails(
    ...
    // TODO: @hoangtule update when implement student external user id
    const isEnabledExternalUserId = await isEnabledFeatureFlag(
        'STUDENT_MANAGEMENT_EXTERNAL_USER_ID'
    );
    if (!isEnabledExternalUserId) {
