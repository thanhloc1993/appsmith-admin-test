...
Feature: [Integration] Edit and save study plan items in individual study plan - Success
    ...
    Scenario Outline: User enters valid dates and saves
        ...
        And school admin sees the values of the course study plan items unaffected
    ...
    #TCID:syl-0380
    Scenario Outline: Due date is auto filled after user enters Start date
        Given school admin is at the "individual" study plan details page
        When school admin edits the study plan content
