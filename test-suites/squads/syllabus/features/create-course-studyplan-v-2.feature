...
Feature: Create course studyplan in course for e2e test
    ...
    #TCID:syl-0055
    @blocker
    Scenario Outline: Create a study plan with a <bookContentType> book
        Given school admin has created a "<bookContentType>" book
        ...
        And school admin sees a new matched studyplan created for master studyplan V2 on CMS
        And school admin sees a new matched studyplan created for all students studyplan V2 on CMS
