...
Feature: Edit some studyplan items' time in Teacher App P1 - "empty start and due date" study plan items
    ...
    #TCID:None
    Scenario Outline: Teacher edits start and due date of some study plan items in studyplan
        ...
        When teacher edits "start date" of "some" study plan items to the "past"
        And teacher edits "due date" of "some" study plan items to the "<timeline>"
    ...
    #TCID:None
    Scenario Outline: Teacher edits start date of some study plan items in studyplan without due date
        Given school admin has created a matched studyplan for student with "empty start and due date" study plan items
        # study plan items are in available time
        When teacher edits "start date" of "some" study plan items to the "<timeline>"
        Then teacher sees the edited time of the study plan items on Teacher App
        And school admin sees the edited time of the study plan items on CMS
    ...
    #TCID:None
    Scenario Outline: Teacher edits due date of some study plan items in studyplan without start date
        Given school admin has created a matched studyplan for student with "empty start and due date" study plan items
        # study plan items are in available time
        When teacher edits "due date" of "some" study plan items to the "<timeline>"
        Then teacher sees the edited time of the study plan items on Teacher App
        And school admin sees the edited time of the study plan items on CMS
