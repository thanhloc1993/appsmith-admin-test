...
export type LearningObjective = Omit<
    LearningObjectiveProto.AsObject,
...
export interface ExamLO
    extends ILearningMaterialBase,
        ...
        Omit<
            ExamLOBase.AsObject,
            'base' | 'totalQuestion' | 'approveGrading' | 'gradeCapping' | 'reviewOption'
        > {
...
export enum LMTypeShortMappedKey {
    lo = 'LEARNING_MATERIAL_LEARNING_OBJECTIVE',
    exam_lo = 'LEARNING_MATERIAL_EXAM_LO',
    fc = 'LEARNING_MATERIAL_FLASH_CARD',
    asgmt = 'LEARNING_MATERIAL_GENERAL_ASSIGNMENT',
    task_asgmt = 'LEARNING_MATERIAL_TASK_ASSIGNMENT',
}
