...
When(
    ...
    async function (field: StudyPlanInfoType) {
        ...
        formData = generateFormDataByStudyPlanInfo(formData, field);
        ...
        // because API is very slow so we need to increase timeout to make sure it can complete in time
        // FIXME: remove when API stable
