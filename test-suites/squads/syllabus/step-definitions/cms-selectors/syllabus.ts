import { draftEditor } from './cms-keys';
...
export const questionItemRoot = getTestId('QuestionItem__root');
...
export const questionGroupDescription = getTestId('QuestionGroupUpsertForm__description');

export const questionGroupDescriptionEditor = `${questionGroupDescription} ${draftEditor}`;
...
export const questionGroupName = getTestId('QuestionTitleWithPoint__title');

export const questionIndividual = getTestId('SingleQuestionBox__root');

export const questionItem = getTestId('QuestionItem__root');

export const questionItemDescription = getTestId('QuestionItem__description');

export const getQuestionItemName = (questionName: string) =>
    `${questionItem}:has-text("${questionName}")`;

export const getQuestionAccordionByName = (questionGroupName: string) =>
    `${questionGroupAccordion}:has-text("${questionGroupName}")`;
...
export const questionGroupListItemByText = (text: string) =>
    `${questionGroupListItem}:has-text("${text}")`;

export const questionInQuestionGroupItemByText = (text: string) =>
    `${questionItemRoot}:has-text("${text}")`;

export const draftEditorContainer = '.DraftEditor-editorContainer';
