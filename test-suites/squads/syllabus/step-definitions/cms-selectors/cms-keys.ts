...
import { getId, getTestId } from 'test-suites/squads/syllabus/utils/common';
...
export const courseAutocomplete = getId('AutocompleteCoursesHF__autocomplete');
...
export const blockImageEditor = getTestId('BlockImage__img');

export const blockAudioEditor = getTestId('BlockAudio__root');

export const imageToolbarEditor = getTestId('ImageOutlinedIcon');

export const audioToolbarEditor = getTestId('VolumeUpOutlinedIcon');

export const uploadFileInputFileDialogEditor = `${getTestId('BaseDialog__root')} ${getTestId(
...
// Form
// TODO: remove when schoolAdminSeesErrorMessageField is refactored/cloned
