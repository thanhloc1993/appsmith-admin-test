export class SyllabusTeacherKeys {
    // Screen
    ...
    static pointsPerQuestion = (points = 1) => `${points} pts`;
    ...
    static userRowInUserManagerKey = `User Row In User Manager`;

    static raiseHandButtonOfStudent = `Raise Hand Button `;

    static microKeyButton = `Micro Is `;

    static cameraKeyButton = `Camera Is `;

    static annotationButton = `Live Lesson Annotation Button`;

    static multiWhiteboardAnnotationButton = `Multi Whiteboard Annotation Button `;
    ...
    static studentStudyPlanItemGradeText = (studyPlanItemName: string): string =>
        `Student Study Plan Item Grade Study Plan Item ${studyPlanItemName}`;

    static courseStudyPlanItemGradeText = (studentName: string, grade: string): string =>
        `Course Study Plan Item Grade Student ${studentName} - Grade ${grade}`;
    ...
    static courseStatisticsStudyPlanItemStartDatePicker = `Course Statistics Study Plan Item start date picker`;

    static studyPlanItemStartDateClearIconButton = `Study Plan Item start date clear icon button`;

    static courseStatisticsStudyPlanItemStartDateClearIconButton = `Course Statistics Study Plan Item start date clear icon button`;

    static courseStatisticsStudyPlanItemEndDateClearIconButton = `Course Statistics Study Plan Item end date clear icon button`;

    static studyPlanItemEndDatePicker = `Study Plan Item end date picker`;

    static courseStatisticsStudyPlanItemEndDatePicker = `Course Statistics Study Plan Item end date picker`;
    ...
    static submissionRowName = (name: string): string => `Submission row ${name}`;

    static menuSelectLoType = `Menu select lo type`;

    static loTypeFilterItem = (loItem: string): string => `${loItem} Lo Type Filter Item`;

    static submissionAttemptHistoryPopUpRow = (index: number): string =>
        `Submission Attempt History Pop Up Row ${index}`;

    static markingPageSaveButton = `Marking Page Save Button`;

    static markingPageAttemptHistoryArrowIcon = `Marking Page Attempt History Arrow Icon`;

    static markingPageTwoSideArrowsButtons = 'Marking Page Two Side Arrows Buttons';

    static markingPageTwoSideArrowsNextButton = 'Marking Page Two Side Arrows Next Button';

    static markingPageTwoSideArrowsPreviousButton = 'Marking Page Two Side Arrows Previous Button';

    static markingPageQuestionGradingInfoBox = 'Marking Page Question Grading Info Box';

    static markingPageQuestionGradingInfoBoxGradedPoint = (isEnabled: boolean) =>
        `Marking Page Question Grading Info Box Graded Point ${isEnabled ? 'Enabled' : 'Disabled'}`;

    static markingPageQuestionGradingInfoBoxPointPerQuestion =
        'Marking Page Question Grading Info Box Point Per Question';

    static markingPageTeacherCommentBox = 'Marking Page Teacher Comment Box';

    static markingPageTeacherCommentBoxTextFieldKey =
        'Marking Page Teacher Comment Box Text Field Key';

    static markingPageStudentInfoBox = 'Marking Page Student Info Box';

    static markingPageStudentInfoBoxAvatar = 'Marking Page Student Info Box Avatar';

    static markingPageStudentInfoBoxName = 'Marking Page Student Info Box Name';

    static markingPageTeacherFeedbackBox = 'Marking Page Teacher Feedback Box';

    static markingPageTeacherFeedbackBoxTextFieldKey =
        'Marking Page Teacher Feedback Box Text Field Key';

    static markingPageScoreInfoBox = 'Marking Page Score Info Box';

    static markingPageScoreInfoBoxScoreTextKey = 'Marking Page Score Info Box Score Text Key';

    static markingPageSubmissionStatusWidget = 'Marking Page Submission Status Widget';

    static searchByStudentNameTextfield = 'Search by student name textfield';

    static searchByLONameTextfield = 'Search by LO name textfield';
}
