import { getRandomElement, randomUniqueIntegers } from '@legacy-step-definitions/utils';
...
export const schoolAdminGoToStudyPlanDetailViaUrl = async (
    ...
    const origin = cms.origin.replace(/\/+$/, '');
    const url = `${origin}/syllabus/study_plans/${studyPlanId}/show?courseId=${courseId}`;
